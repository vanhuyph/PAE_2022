...
public class UtilisateurDAO {
    ...
    public UtilisateurDTO rechercheParPseudo(String pseudo){
        try {
            ResultSet rs = servicesDAL.getPs("SELECT u.id_utilisateur, u.pseudo, u.nom, u.prenom, u.mdp, u.gsm, u.est_admin FROM projet.utilisateurs u WHERE u.pseudo = pseudo").executeQuery();
