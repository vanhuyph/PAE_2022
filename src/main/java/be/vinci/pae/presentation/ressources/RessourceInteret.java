    ...
    public InteretDTO creetInteret(JsonNode json) throws Exception{
        ...
        if(!json.hasNonNull("idUtilisateurInteresse")
            ...
            throw new WebApplicationException(Response.status(Response.Status.BAD_REQUEST)
                    .entity("id de l'utilisateur ou de l'objet ou date manquant").type("text/plain").build());
        }
        ...
        Date dateJava = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm", Locale.FRANCE).parse(dateRdvString);
